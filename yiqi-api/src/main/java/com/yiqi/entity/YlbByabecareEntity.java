 ...
 */
@TableName("ylb_byabecare")
public class YlbByabecareEntity implements Serializable {
	 ...
	 * 是否母婴证
	 */
	private Integer isbaybecertificate;
	/**
	 * 
	 */
	 ...
	 * 设置：是否母婴证
	 */
	public void setIsbaybecertificate(Integer isbaybecertificate) {
		this.isbaybecertificate = isbaybecertificate;
	}
	/**
	 * 获取：是否母婴证
	 */
	public Integer getIsbaybecertificate() {
